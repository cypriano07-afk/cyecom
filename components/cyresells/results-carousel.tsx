...
function ResultCard({ src, index }) {
    return h(
      ...
      {
              className:
                        "relative shrink-0 w-[190px] md:w-[230px] rounded-2xl border border-white/10 bg-[#0a0908] shadow-2xl shadow-black/60 overflow-hidden",
      },
          h("img", {
                  src: src,
                ...
                h(
                  ...
                  { className: "text-center" },
                          ...
                          h(
                            ...
                            {
                                          className:
                                                          "text-[#C9A84C] text-2xl md:text-3xl lg:text-4xl font-bold",
                            },
